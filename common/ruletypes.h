...
RULE_INT(World, LoadZoneID, 184, "Zone ID of the tutorial")
...
RULE_INT(World, ExemptAccountLimitStatus, 250, "")
RULE_BOOL(World, EnforceCharacterLimitAtLogin, true, "")
RULE_CATEGORY_END()
...
RULE_INT(Zone, GlobalLootProbabilityOverride, -1, "Sets Global Loot drop probability for database based drops")
RULE_BOOL(Zone, GlobalLootForceAllDropsOverride, false, "Sets all mobs to drop all items they could possibly drop all in one go")
...
RULE_INT(Spells, BlindBreakCheckChance, 75, "Determines chance for a fear break check to occur each buff tick")
